...
def test_deductive_confidence():
    ...
    print(f"✅ apply_modus_ponens(True, True) -> {result}, confidence: {chain.steps[0].confidence}")
    ...
    print(f"✅ apply_modus_ponens(False, True) -> {result}, confidence: {chain_invalid.steps[0].confidence}")
